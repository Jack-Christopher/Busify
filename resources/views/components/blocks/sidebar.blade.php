<aside 
    x-data="{ isVisible: window.innerWidth >= 640 }"
    class="fixed top-0 left-0 z-40 h-screen pt-20 transition-transform  bg-white border-r border-gray-200 translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="flex flex-row h-full"
        :class"{ 'w-64': isVisible, 'w-12': ! isVisible }">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800" :class="{'block': isVisible, 'hidden': ! isVisible}">
        ...
        <div class="flex items-center px-4 -mr-12">
            <button @click="isVisible = ! isVisible" class="inline-flex items-center justify-center p-2 rounded-md bg-gray-200 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-400 focus:text-gray-500 dark:focus:text-gray-400 transition duration-150 ease-in-out">
